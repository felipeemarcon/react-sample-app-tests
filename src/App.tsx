import { CardContainer, GroupHeader, JadeProvider, ListItem, Text } from '@stone-payments/jade';
...
export default function App() {
  ...
  return (
    <JadeProvider theme="stone" portalRoot={portalRef}>
      <div
      ...
      <div id="jade-portal-root" ref={portalRef} />
    </JadeProvider>
  );
}
